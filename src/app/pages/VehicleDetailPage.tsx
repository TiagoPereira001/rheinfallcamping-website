            ...
            <div className="bg-white rounded-2xl border border-black/5 overflow-hidden">
              <div className="grid grid-cols-2 divide-x divide-y divide-black/5">
                <div className="p-4 md:p-6">
                  <span className="block text-xs uppercase tracking-wider text-black/40 mb-1">Ano</span>
                  <span className="font-medium text-black">{vehicle.year}</span>
                </div>
                <div className="p-4 md:p-6">
                  <span className="block text-xs uppercase tracking-wider text-black/40 mb-1">Quilómetros</span>
                  <span className="font-medium text-black">{vehicle.km}</span>
                </div>
                <div className="p-4 md:p-6">
                  <span className="block text-xs uppercase tracking-wider text-black/40 mb-1">Transmissão</span>
                  <span className="font-medium text-black">Manual</span>
                </div>
                <div className="p-4 md:p-6">
                  <span className="block text-xs uppercase tracking-wider text-black/40 mb-1">Combustível</span>
                  <span className="font-medium text-black">Diesel</span>
                </div>
                <div className="p-4 md:p-6">
                  <span className="block text-xs uppercase tracking-wider text-black/40 mb-1">Lotação</span>
                  <span className="font-medium text-black">4 pessoas</span>
                </div>
                <div className="p-4 md:p-6">
                  <span className="block text-xs uppercase tracking-wider text-black/40 mb-1">Garantia</span>
                  <span className="font-medium text-black">18 Meses</span>
                </div>
              </div>
            </div>
          </div>
