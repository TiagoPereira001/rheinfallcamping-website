  ...
  return (
    <div className="bg-[#f4f4f2] min-h-screen py-16 md:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <div className="mb-12">
          <h1 className="font-serif text-black text-4xl md:text-5xl font-medium mb-4">O nosso Stock</h1>
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          <aside className="w-full lg:w-64 shrink-0">
            <div className="bg-white rounded-2xl p-6 border border-black/5 shadow-sm sticky top-24">
              ...
              <div className="space-y-6">
                <div>
                  <label className="block text-xs font-semibold uppercase tracking-wider text-black/40 mb-3">Preço</label>
                ...
                <div>
                  <label className="block text-xs font-semibold uppercase tracking-wider text-black/40 mb-3">Ano</label>
                  <select className="w-full bg-[#f4f4f2] text-sm rounded-lg p-2.5 outline-none focus:ring-1 ring-black/20">
                ...
                <div>
                  <label className="block text-xs font-semibold uppercase tracking-wider text-black/40 mb-3">Marca</label>
          ...
          <div className="flex-1">
            ...
            <div className="mt-12 flex items-center justify-center gap-2">
              ...
              <button className="w-10 h-10 flex items-center justify-center rounded-lg bg-black text-white text-sm font-medium">1</button>
              <button className="w-10 h-10 flex items-center justify-center rounded-lg hover:bg-black/5 text-black/70 text-sm font-medium transition-colors">2</button>
